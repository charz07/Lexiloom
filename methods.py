...
def chatbot():
    context = "You are a language assistant. Your primary role is to help users with language-related queries, such as grammar, vocabulary, translation, and language learning tips."
    print("Language Assistant: Hello! I'm your language assistant. How can I help you today?")
    ...
    while True:
        ...
        print("Language Assistant:", response)  
